...
playlist.pop();
let removeLastSong = playlist.pop();
console.log(playlist)
...
message = message.concat(", and our specials include ", specials.DrinkSpecial);

// 16 - Use concat() to concatenate the string ", along with our playlist of " with the value of the 
//`totalSongs` variable

console.log(message.concat(", along with our playlist of ", totalSongs));
